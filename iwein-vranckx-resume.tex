...
\headedsection
  ...
  \headedsubsection
	...
	\deemph{Keywords: MATLAB, C++, cuBLAS, CUDA, Python, Git, global optimization.}
}}
...
\inlineheadsection	
  ...
  {Sourdough bread baking (COVID related hobby), chess, OOP-programming, jogging, cycling, typography (e.g. \LaTeX), fraud detection, macrobiotic food, cooking, intra-disciplinary research collaboration, valorization of innovation, travel, speaking at conferences.}
