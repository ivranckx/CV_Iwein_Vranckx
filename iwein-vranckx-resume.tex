...
016.43.83.29\sbull 475.75.34.92\sbull
...
Due to the time criticalness of our industrial classification tasks in day-to-day operations, combined with the vast amount of spectroscopic data, research into new, high performance (non-linear) modelling was essential. 
My research therefore focused specifically on the computational improvement of (ensembles of) LS-SVM's based on GPGPU's, which where then applied to spectroscopic datasets of various food related products. We effectively demonstrate the corresponding machine efficiency improvements and improved classification training times.
